      ...
      <header className="bg-white shadow">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-t border-gray-200">
          <nav className="flex space-x-8 space-x-reverse">
            <Link href="/dashboard" className="px-3 py-3 text-sm font-medium text-blue-600 border-b-2 border-blue-600">
              محصولات
            </Link>
            <Link href="/dashboard/toys" className="px-3 py-3 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-b-2 hover:border-gray-300">
              اسباب بازی‌ها
            </Link>
          </nav>
        </div>
