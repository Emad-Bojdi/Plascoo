...
export default function NewProductWithProfit() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.name || !pricesCalculated) {
      setError('لطفا نام محصول را وارد کنید و قیمت‌ها را محاسبه کنید');
      return;
    }
      ...
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto py-4 sm:py-6 px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-0">
            <h1 className="text-xl sm:text-2xl font-bold text-gray-900">افزودن محصول جدید با محاسبه سود</h1>
